...
export const lobbyLayout: LobbyLayout = {
  ...
  roasterCard: { x: 44, y: 395, width: 425, scale: 0.98, zIndex: 30 },
  drinkStationCard: { x: 472, y: 388, width: 425, scale: 0.98, zIndex: 30 },
  cashierCard: { x: 44, y: 917, width: 424, scale: 1, zIndex: 30 },
  shopCard: { x: 472, y: 919, width: 420, scale: 1, zIndex: 30 },
