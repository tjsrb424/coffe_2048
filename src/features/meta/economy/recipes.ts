...
export const RECIPE_DEFINITIONS: Record<DrinkMenuId, RecipeDefinition> = {
  ...
  vanilla_latte: {
    ...
    firstCraftKey: "recipe:vanilla_latte:firstCraft",
  },
  mocha: {
    id: "mocha",
    name: "카페 모카",
    ...
    firstCraftKey: "recipe:mocha:firstCraft",
  },
  matcha_latte: {
    id: "matcha_latte",
    name: "말차 라떼",
    ...
    firstCraftKey: "recipe:matcha_latte:firstCraft",
  },
  nutty_cloud: {
    id: "nutty_cloud",
    name: "너티 클라우드",
    ...
    firstCraftKey: "recipe:nutty_cloud:firstCraft",
  },
  affogato: {
    id: "affogato",
    name: "아포가토",
